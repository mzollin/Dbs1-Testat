...
INSERT INTO glas_typ VALUES ('Whisky Glas', 2, 250, 7, 8);
...
INSERT INTO cocktail_rezept VALUES ('Martini', 'Martini Glas', TRUE);
INSERT INTO cocktail_rezept VALUES ('Virgin Martini', 'Martini Glas', FALSE);
...
INSERT INTO cocktail_rezept VALUES ('Old Fashioned', 'Old Fashioned Glas', TRUE);
INSERT INTO cocktail_rezept VALUES ('Whisky', 'Whisky Glas', TRUE);

-- TABLE ZUTATEN
-- format: name, vorrat_ml / stueckzahl, alkohol_volproz
...
INSERT INTO zutaten VALUES ('Kokosnussmilch', 150, 0),
                           ('Ananassaft', 500, 0),
                           ('Ananasschnitz', 16, 0),
                           ('Cocktailschirmchen', 7, 0);
INSERT INTO zutaten VALUES ('Zuckerwuerfel', 30, 0);

-- TABLE ZUTATENZUTEILUNG
-- format: cocktail_rezept, zutaten, volumen_ml / stueckzahl
...
INSERT INTO zutaten_zuteilung VALUES ('Pina Colada', 'Rum hell', 30),
                                     ...
                                     ('Pina Colada', 'Cocktailschirmchen', 1);
INSERT INTO zutaten_zuteilung VALUES ('Old Fashioned', 'Whisky', 45),
                                     ('Old Fashioned', 'Angosturabitter', 5),
                                     ('Old Fashioned', 'Zuckerwuerfel', 1),
                                     ('Old Fashioned', 'Wasser', 5);
...
INSERT INTO festzutaten VALUES ('Orangenschale', 1, 1, 2.5, 4);
...
INSERT INTO festzutaten VALUES ('Zuckerwuerfel', 1, 1, 2, 3);
